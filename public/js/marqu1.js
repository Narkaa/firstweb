; (function () {
    ...
    var marquee_el = document.querySelector('.grid1.marquee1');
    var children = marquee_el.querySelectorAll('.cell1');
    ...
    function createMarquee() {
        ...
        if ('animate' in marquee_el
            ...
            displacement = (displacement - marquee_el.clientWidth + 800) << 0;
    ...
    function playMarquee() {
        if (marquee1.playState === 'paused') marquee1.play();
    }

    // pretty self-explanatory
    function pauseMarquee() {
        if (marquee1.playState === 'running') marquee1.pause();
    }
